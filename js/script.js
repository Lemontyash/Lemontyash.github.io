let N_cube = prompt("Введите желаемок кол-во кубов:", 10);

let xyz = prompt("Введите спавн по оси ,x,y или z", "z");

let plus_unplus = prompt("Вот еще вопрос z(+ - дальше ,- - ближе  ),y(+ - выше ,- - ниже  ),x(+ - правее ,- - левее  )", "+");

alert('WASD to move, Space - go up, Shift - go down,Arrow - camera rotate');
...
let material_ov = new THREE.MeshPhongMaterial({
  color: "#C92639"
});
...
let material_ov1 = new THREE.MeshPhongMaterial({
  color: "#5D68C9"
});
...
let material_ov2 = new THREE.MeshPhongMaterial({
  color: "#29C92C"
});
...
let material_ov3 = new THREE.MeshPhongMaterial({
  color: "#FFF200"
});
...
let material_ov4 = new THREE.MeshPhongMaterial({
  color: "#A3FFFF"
});
...
let material_ov5 = new THREE.MeshPhongMaterial({
  color: "#FF46F3"
});
...
let material_ov6 = new THREE.MeshPhongMaterial({
  color: "#FF5990"
});
...
let material_ov7 = new THREE.MeshPhongMaterial({
  color: "#FFB134"
});
...
let material_cilinder = new THREE.MeshPhongMaterial({
  color: "#FFFFFF"
});
...
let material_cilinder2 = new THREE.MeshPhongMaterial({
  color: "#FFFFFF"
});
...
let material_cilinder3 = new THREE.MeshPhongMaterial({
  color: "#FFFFFF"
});
...
let material_cilinder4 = new THREE.MeshPhongMaterial({
  color: "#FFFFFF"
});
...
//
  ...
  let  material_cilinder5 = new THREE.MeshPhongMaterial({
        color: "#FFFFFF"
      });
...
let material_cilinder6 = new THREE.MeshPhongMaterial({
  color: "#FFFFFF"
});
...
let material_cilinder7 = new THREE.MeshPhongMaterial({
  color: "#FFFFFF"
});
...
let material_cilinder8 = new THREE.MeshPhongMaterial({
  color: "#FFFFFF"
});
...
let material_cilinder9 = new THREE.MeshPhongMaterial({
  color: "#FFFFFF"
});
...
let material_cilinder10 = new THREE.MeshPhongMaterial({
  color: "#FFFFFF"
});
...
let cylinder10 = new THREE.Mesh(geometry_cilinder10, material_cilinder10); // Массив
  ...
  //
    ...
    let  material_cilinder11 = new THREE.MeshPhongMaterial({
          color: "#FFFFFF"
        });
  ...
  let  material_cilinder12 = new THREE.MeshPhongMaterial({
      color: '#FFFFFF'
    });
...
if (xyz == "x") {
  ...
  if (plus_unplus == "+") {
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {



      sphere = new THREE.Mesh(geometry_ov, material_ov);
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      sphere1 = new THREE.Mesh(geometry_ov1, material_ov1);

      sphere1.position.x = 0;

      sphere1.position.x += i;
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      sphere2 = new THREE.Mesh(geometry_ov2, material_ov2);

      sphere2.position.x = -10;
      sphere2.position.z = 10;

      sphere2.position.x += i;
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      sphere3 = new THREE.Mesh(geometry_ov3, material_ov3);

      sphere3.position.x = 0;
      sphere3.position.z = 10;

      sphere3.position.x += i;
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      sphere4 = new THREE.Mesh(geometry_ov4, material_ov4);

      sphere4.position.z = 0;
      sphere4.position.x = -10;
      sphere4.position.y = 10;

      sphere4.position.x += i;
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      sphere5 = new THREE.Mesh(geometry_ov5, material_ov5);

      sphere5.position.z = 0;
      sphere5.position.x = 0;
      sphere5.position.y = 10;

      sphere5.position.x += i;
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      sphere6 = new THREE.Mesh(geometry_ov6, material_ov6);

      sphere6.position.x = -10;
      sphere6.position.z = 10;
      sphere6.position.y = 10;

      sphere6.position.x += i;
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      sphere7 = new THREE.Mesh(geometry_ov7, material_ov7);

      sphere7.position.x = 0;
      sphere7.position.z = 10;
      sphere7.position.y = 10;

      sphere7.position.x += i;
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      cylinder = new THREE.Mesh(geometry_cilinder, material_cilinder); // Массив
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      cylinder2 = new THREE.Mesh(geometry_cilinder2, material_cilinder2); // Массив

      cylinder2.position.x = -10;
      cylinder2.position.z = 10;
      cylinder2.position.y = 5;

      cylinder2.position.x += i;
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      cylinder3 = new THREE.Mesh(geometry_cilinder3, material_cilinder3); // Массив

      cylinder3.position.x = 0;
      cylinder3.position.y = 5;
      cylinder3.position.z = 0;

      cylinder3.position.x += i;
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      cylinder4 = new THREE.Mesh(geometry_cilinder4, material_cilinder4); // Массив

      cylinder4.position.z = 0;
      cylinder4.position.x = -10;
      cylinder4.position.y = 5;

      cylinder4.position.x += i;
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      cylinder5 = new THREE.Mesh(geometry_cilinder5, material_cilinder5); // Массив
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      cylinder6 = new THREE.Mesh(geometry_cilinder6, material_cilinder6); // Массив
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      cylinder7 = new THREE.Mesh(geometry_cilinder7, material_cilinder7); // Массив
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      cylinder8 = new THREE.Mesh(geometry_cilinder8, material_cilinder8); // Массив
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      cylinder9 = new THREE.Mesh(geometry_cilinder9, material_cilinder9); // Массив
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      cylinder10 = new THREE.Mesh(geometry_cilinder10, material_cilinder10); // Массив
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      cylinder11 = new THREE.Mesh(geometry_cilinder11, material_cilinder11); // Массив
    ...
    for (let i = 0; i < N_cube * 15; i += 15) {
      ...
      cylinder12 = new THREE.Mesh(geometry_cilinder12, material_cilinder12); // Массив
